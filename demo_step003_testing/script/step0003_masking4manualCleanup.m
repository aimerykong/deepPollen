...
%%
basepath = '/home/skong2/restore/dataset/pollen_catatumbus/dataset_part2_by_Ingrid/cmax';
outpath = '/home/skong2/restore/dataset/pollen_catatumbus/dataset_part2_by_Ingrid/annotation_mask4manualCleanup';
if ~isdir(outpath)
    mkdir(outpath);
end
