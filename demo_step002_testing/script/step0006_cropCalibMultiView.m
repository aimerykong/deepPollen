...
%%
path_to_cmax = '/home/skong2/restore/dataset/pollen_catatumbus/dataset_part2_by_Ingrid/cmax_smart';
...
outpath = '/home/skong2/restore/dataset/pollen_catatumbus/dataset_part2_by_Ingrid/annotation_cropCalibMultiView_640x640';
if ~isdir(outpath)
   mkdir(outpath);
end
